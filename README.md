...
Note: The current authentication flow primarily uses the token cookie. express-session is not required if session-based authentication is not being used elsewhere.
